...
$uemail=mysqli_real_escape_string($link,trim($_GET["uname"]));
...
$join_referal_reward=$rfrow["JoiningWithReferalAmount"];
	...
	elseif(!filter_var($uemail, FILTER_VALIDATE_EMAIL))
   {
	...
	{
		//$q="select * from tblusers where UserEmail='$uemail' and UserPassword='$upass'";
		...
		{
			$q1="insert into tblusers(UserType,UserEmail,UserPassword,UserRegistrationDate,CreatedBy) values('$utype','$uemail','$upass','$regdate','$createdby')";
