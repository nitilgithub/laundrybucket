		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="title-page">Order Now</div>
					<ol class="breadcrumb">
...
<?php
					...
					function submit_order($uid,$name,$email,$phone,$city,$pickup_address,$pickdate,$picktime,$order_status_id,$remarks,$remarksby,$remarksbyid,$order_via,$createdby,$offers,$offerid)
					{
					//header("location:thanku.php");
					...
					$result=mysql_query("insert into tbl_orders(OrderUserId,OrderCity,PickupAddress,Order_PickDate,Order_Picktime,addon,OrderStatusId,Remarks,Order_Via,CreatedBy,UserDemandOffer,franchiseId,comboOfferId) values('$uid','$city','$pickup_address','$pickdate','$picktime',NOW(),'$order_status_id','$remarks','$order_via','$createdby','$offers','1','$offerid')") or die(mysql_error());
					...
					<h2 class="section-heading">
						...
						if(isset($_GET['offer'])){}
							...
							?>
						<p style="font-size: 14px; letter-spacing: 1px;">Minimum Order is ₹300 or above</p>	
							<?php
						}
						?>
					...
					<form class="form-contact" method="post" data-form-title="PROVIDE YOUR PICK UP DETAILS" name="ordern" onsubmit="return validateorderform(document.ordern.name,document.ordern.phone,document.ordern.laundry,document.ordern.dryclean)>
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12">
								<div class="form-group">
									<div id="success"></div>
									<button type="submit" name="submitorder" class="btn btn-secondary">PLACE ORDER</button>
								</div>
							</div>
						</div>
					</form>
...
$remarksbyid=$uid;
	...
	if(!empty($msg))
			...
			submit_order($uid,$name,$email,$phone,$city,$pickup_address,$pickdate,$picktime,$order_status_id,$remarks,$remarksby,$remarksbyid,$order_via,$createdby,$offers,$offerid);
