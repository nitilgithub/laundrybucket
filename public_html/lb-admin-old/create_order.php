...
?>
		...
		if(isset($_POST["btnsave"]))
		{
			...
			$deliverydate=(empty($_POST["deliverydate"])? "NULL" : "'".trim(mysql_real_escape_string($_POST["deliverydate"]))."'");
...
if(isset($_POST["subtype"]))
	...
	$uid=mysql_real_escape_string($_GET["userid"]);  //userid if user is placing order after login to account
                                  ...
                                  &nbsp;                               
            						...
            						<option value=""  style="padding-bottom:7px">Select Order Type</option>
            						  ...
            						  <option value="laundry" class="btnsubschk"  style="padding-bottom:7px"> Laundry Order</option>
										...
										<option value="reprocess"  style="padding-bottom:7px"> Reprocess Order</option>
