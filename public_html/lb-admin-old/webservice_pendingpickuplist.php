...
//										$result=mysql_query("select * from tbl_orders where Order_PickDate='$dt' or Order_PickDate='$dt1'  order by OrderId DESC") or die(mysql_error());
...
<str_to_date('$dt','%m/%d/%Y') )) and OrderStatusId=0 order by OrderId DESC";
