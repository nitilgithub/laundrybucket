...
<!--                              <div id="columnchart_material" style="width: 900px; height: 500px;"></div>--
 ...
 $(function () {
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://laundrybucket.co.in/lb-admin/webservice_yearly_order1.php?ref=Dryclean&val=<?php echo $val; ?>',
           'dataType': "json",
 ...
 //BAR CHART
      ...
      $(function () {
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://laundrybucket.co.in/lb-admin/webservice_yearly_order1.php?ref=Laundry&val=<?php echo $val; ?>',
           'dataType': "json",
           'success': function (data) {
               json = data;
           }
