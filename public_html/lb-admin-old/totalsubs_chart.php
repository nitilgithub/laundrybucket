...
?>
  ...
  <!--Load the AJAX API--
    ...
    function drawChart() {
      var jsonData = $.ajax({
          url: "https://laundrybucket.co.in/lb-admin/webservice_totalsubs_chart.php",
          dataType: "json",
          async: false
          }).responseText;
 ...
 <div class="">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i> Total User  Subscription in year <?php echo $val; ?>
...
<!--                              <div id="columnchart_material" style="width: 900px; height: 500px;"></div>--
 ...
 <script type="text/javascript">          
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://laundrybucket.co.in/lb-admin/webservice_totalsubs_chartnew1.php?val=<?php echo $val; ?>',
           'dataType': "json",
