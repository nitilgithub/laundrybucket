...
?>
 <form method="post" role="form" class="form-horizontal" name="ordern" enctype="multipart/form-data" onsubmit="return validateorderform(document.ordern.name)">
            			  ...
            			  <input type="text" class="form-control" readonly  id="pickadd" name="address" value="<?php echo $rows["UserAddress"]; ?>" required="" placeholder="Enter Customer Pickup Address" data-form-field="address">
            			       </div>
              			...
              			<div class="col-md-12" style="border:1px solid red">
				         	...
				         	<!-- We can not do nested form, so we do this using ajax without form tag-->
				         	   <div class="row">
				               	...
				               	<div class="form-group">
                            	<input type="text" class="form-control text-capitalize hidden" value="<?php echo $userid; ?>" id="getuid"  name="getuid" required="" placeholder="Enter Last Name*" data-form-field="LastName">
