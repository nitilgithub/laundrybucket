    ...
    'click .btndetail': function (e, value, row, index) {
     ...
     'click .btncancel': function (e, value, row, index) {
        var r=confirm("Do you really want to cancel this Order");
  		if(r==true)
  		{
  		window.location.href="cancel_normalorder.php?id="+row.order_id;
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Laundry</a>
                                            </li>
...
<!-- End Button for multiple delete-->                                    
                               ...
                               <table data-toggle="table" id="drycleantable"  data-url="webservice_normalorder.php" data-pagination="true" data-show-refresh="true" data-show-toggle="true"  data-show-columns="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true">
