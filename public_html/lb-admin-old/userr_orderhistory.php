...
<?php
$user_id=intval(trim(mysql_real_escape_string($_GET["id"])));
...
<?php
  if(isset($_GET["id"]))
{
	 $result=mysql_query("select * from tbl_orders where OrderUserId='$user_id'") or die(mysql_error());
 ...
 <!-- Start Section for Subscription Order Details-->
 		<div class="">
 			<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                       <h2 class="text-capitalize"><i class="fa fa-bars"></i> <?php echo $row["OrderShipName"]." 's" ; ?> Order Detail </h2>
