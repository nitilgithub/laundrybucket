...
window.actionEvents = {
 ...
 <div class="fixed-table-toolbar">
  ...
  <div class="columns columns-left btn-group pull-left">
    ...
    <thead>
    <tr>					<th data-field="action" data-formatter="actionFormatter" data-events="actionEvents">Action</th>			
	      <th data-field=" " data-checkbox="true"></th>        <th data-field="id" data-align="left" data-sortable="true">ID</th>
          <th data-field="subs_name" data-align="center">Subscription Name</th>                    <th data-field="subs_servicetype" data-align="center">Subscription Service</th>                    <th data-field="subs_garmenttype" data-align="center">Subscription Garment</th>
          <th data-field="subs_cost" data-align="center">Subscription Cost</th>
          <th data-field="subs_weight" data-align="center">Subscription Weigth</th>
          <th data-field="subs_maxpickup" data-align="center">Subs_maxpickup</th>                    <th data-field="subs_remarks" data-align="center">Remarks</th>
