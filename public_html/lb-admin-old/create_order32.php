...
function submit_order($uid,$name,$ord_type,$email,$phone,$pickup_address,$pickdate,$picktime,$order_status_id,$delivery_type,$remarks,$remarksby,$remarksbyid,$ussubstype,$order_via,$createdby)
{
	...
	$adminmessage = file_get_contents('../email_template/adminorderemail.html');
		...
		$result=mysql_query("insert into tbl_orders(OrderType,OrderUserId,User_Subsid,OrderShipName,OrderEmail,OrderPhone,OrderShipAddress,Order_PickDate,Order_Picktime,OrderDate,OrderStatusId,OrderDeliveryType,Review,Order_Via,CreatedBy) values('$ord_type','$uid','$ussubstype','$name','$email','$phone','$pickup_address','$pickdate','$picktime',NOW(),'$order_status_id','$delivery_type','$remarks','$order_via','$createdby')") or die(mysql_error());
...
?>
		...
		if(isset($_POST["btnsave"]))
		{
			...
			$pickup_address=trim(mysql_real_escape_string($_POST["address"]));
			$pickdate=trim(mysql_real_escape_string($_POST["pickdate"]));
			$picktime=trim(mysql_real_escape_string($_POST["picktime"]));
			
			$delivery_add=trim(mysql_real_escape_string($_POST["address"]));
			$delivery_type=mysql_real_escape_string($_POST["dtype"]);
			$ord_type=trim(mysql_real_escape_string($_POST["ordercat"]));
...
if(isset($_POST["subtype"]))
			{
				$ussubstype=trim(mysql_real_escape_string($_POST["subtype"]));
	...
	$uid=mysql_real_escape_string($_GET["uid"]);  //userid if user is placing order after login to account
...
if(mysql_num_rows($result)>0)
{
	...
	$result2=mysql_query("insert into tblusers(UserFirstName,UserLastName,UserEmail,UserPhone,UserPhone2,UserPassword,UserAddress,UserRegistrationDate,UserEmailVerified,UserType,CreatedBy) values('$name','$email','$phone1','$phone2','$upass','$pickup_address','$regdate','$uevstatus','$usertype','$ucreatedby')");
...
$remarksbyid="NULL";
				...
				if($ord_type=="trial_laundry")
		{
				...
				submit_order($uid,$name,$ord_type,$email,$phone,$pickup_address,$pickdate,$picktime,$order_status_id,$delivery_type,$remarks,$remarksby,$remarksbyid,$ussubstype,$order_via,$createdby);
				}
		}
...
?>
 <form method="post" role="form" class="form-horizontal" name="ordern" enctype="multipart/form-data" onsubmit="return validateorderform(document.ordern.name)">
                                      ...
                                      <input type="email" class="form-control col-md-7 col-xs-12" readonly="" disabled=""  id="email" name="email" value="<?php echo $rows["UserEmail"]; ?>"   placeholder="Enter Customer Email Id" data-form-field="Email">
                            ...
                            if(empty($rows["UserPhone"]))
							{
								?>
                                         ...
                                         <input type="tel" class="form-control col-md-7 col-xs-12 phone hidden" readonly="" disabled="" name="phone1" value="<?php echo $rows["UserPhone"]; ?>"  data-inputmask="'mask' : '9999999999'" placeholder="Enter Customer Mobile no" data-form-field="Phone">
                                        ...
                                        &nbsp;
                                         ...
                                         <input type="tel" class="form-control col-md-7 col-xs-12" name="phone2" required="" value="<?php echo $rows["UserPhone2"]; ?>"  data-inputmask="'mask' : '9999999999'" placeholder="Enter Customer Mobile no" data-form-field="Phone">
							...
							<?php	
								...
								?>
								 <div class="item form-group" id="usmobile">
                                         ...
                                         <input type="tel" class="form-control col-md-7 col-xs-12 phone" readonly="" disabled=""  name="phone1" required="" value="<?php echo $rows["UserPhone"]; ?>"  data-inputmask="'mask' : '9999999999'" placeholder="Enter Customer Mobile no" data-form-field="Phone">
                                        ...
                                        &nbsp;
                                         ...
                                         <input type="tel" class="form-control col-md-7 col-xs-12" name="phone2"  value="<?php echo $rows["UserPhone2"]; ?>"  data-inputmask="'mask' : '9999999999'" placeholder="Enter Customer Alternate Mobile no" data-form-field="Phone">
	 ...
	 <form method="post" role="form" class="form-horizontal" name="ordern" enctype="multipart/form-data" onsubmit="return validateorderform(document.ordern.name,document.ordern.email,document.ordern.phone)">
                                      ...
                                      <input type="email" class="form-control col-md-7 col-xs-12" id="email" name="email"   placeholder="Enter Customer Email Id" data-form-field="Email">
                                         ...
                                         <input type="tel" class="form-control col-md-7 col-xs-12 phone" name="phone1" required="" data-inputmask="'mask' : '9999999999'" placeholder="Enter Customer Mobile no" data-form-field="Phone">
