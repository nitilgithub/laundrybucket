...
$subs_id = mysql_real_escape_string($_GET['subsid']);
...
$row=mysql_fetch_array($result)  ?>
   									...
   									<label class="control-label col-md-3 col-sm-3 col-xs-12" for="subsname"> Subscription name 
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-5" >
                                	           ...
                                	           <input type="text" name="subsservicetype" value="<?php echo $row["Subs_ServiceType"]; ?>" id="subsservicetype" class="form-control col-md-7 col-xs-12" disabled/>                    	
                                				</div>
           ...
           <div class="form-group">				
         							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="subscost">Subs_Maximum Pickup
                                            ...
                                            <div class="col-md-3 col-sm-2 col-xs-5" >
                                	           ...
                                	           <input type="text" name="subs_garmenttype" value="<?php echo $row["Subs_GarmentType"]; ?>" id="subswt" class="form-control col-md-7 col-xs-12" disabled/>                    	
                                				</div>
