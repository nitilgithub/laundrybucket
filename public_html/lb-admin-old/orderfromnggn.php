 ...
 <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Orders from Noida, Ghaziabad, Greater Noida Per month</h3>
                        </div>
...
<!--                              <div id="columnchart_material" style="width: 900px; height: 500px;"></div>-->
                ...
                <div class="box-header">
                  <h3 class="box-title">Orders in <?php echo $val; ?></h3>
                </div>
 ...
 $(function () {
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://laundrybucket.co.in/lb-admin/webservice_orderfromnggn.php?val=<?php echo $val; ?>',
           'dataType': "json",
 ...
 //BAR CHART
        var bar = new Morris.Bar({
          ...
          resize: true,
          data: json,
          barColors: ['#00a65a', '#f56954','#5F9EA0'],
          xkey: 'y',
          ykeys: ['a','b','c'],
          labels: ['Noida','Greater Noida','Ghaziabad'],
          hideHover: 'auto'
        });
