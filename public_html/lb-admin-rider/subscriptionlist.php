...
tbody td {display: block; }
  ...
  td:nth-of-type(4):before { 
    content: 'Extra Weight Cost(per kg):' ; 
    display: block;
     
  }
  td:nth-of-type(5):before { 
    content: 'Extra Pickup Cost(per pickup):' ; 
    display: block;
...
<?php } ?>
    ...
    <tr>				
    	...
    	<?php } ?>
	      ...
	      <th data-field="subs_detail">Subscription</th>   
         ...
         <!-- <th data-field="subs_name" data-align="center">Subscription Name</th>                    
          ...
          -->
           ...
           <th data-field="subs_extra_wt_cost">Extra Weight Cost<br>(per kg)</th>  
           
        
          
           <th data-field="subs_extra_pickup_cost">Extra Pickup Cost<br>(per pickup)</th>     
