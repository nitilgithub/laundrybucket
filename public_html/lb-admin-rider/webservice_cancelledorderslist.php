...
$orderdetail="Id: ".$row["OrderId"]."<br>Pickup: ".$row["Order_PickDate"]."<br>Amount: ".$row_array['order_total_amt_weight']."<br>".$data2['order_status_text'];

$clientdetail=$row1["UserFirstName"]." ".$row1["UserLastName"]."<br>".$row1["UserEmail"]."<br>".$row1["UserPhone"]."<br>".$row1['UserAddress'].", ".$row1['UserCity'];
