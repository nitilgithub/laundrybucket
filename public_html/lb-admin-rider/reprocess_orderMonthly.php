 ...
 <div class="">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i>Total reprocess orders per month</h2>
...
<!--                              <div id="columnchart_material" style="width: 900px; height: 500px;"></div>-->
                ...
                <div class="box-header">
                  <h3 class="box-title">Reprocess orders in <?php echo $val; ?></h3>
                </div>
 ...
 $(function () {
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://www.laundrybucket.co.in/lb-admin/webservice_reprocess_orderMonthly.php?val=<?php echo $val; ?>',
           'dataType': "json",
