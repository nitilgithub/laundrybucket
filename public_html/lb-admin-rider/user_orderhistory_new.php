...
window.actionEvents = {
    'click .btnedit': function (e, value, row, index) {
        window.location.href="place_order.php?oid="+row.ord_no;
    }
    /*
    'click .btndel': function (e, value, row, index) {
      ...
      'click .btnorderhistory': function (e, value, row, index) {
        window.location.href="suborder_dashboard.php?oid="+row.ord_no;
    }
...
<div class="right_col" role="main" style="min-height: 1500px">
	...
	?>     
		                       ...
		                       <ul class="nav navbar-right panel_toolbox">
                   			 ...
                   			 <div class="x_content table-responsive">
	                  			 ...
	                  			 <div class="fixed-table-toolbar">
									  ...
									  -->
									 <table data-toggle="table" id="table" data-url="webservice_user_orderhistory_new.php?uid=<?php echo $user_id;?>" data-pagination="true" data-show-refresh="true" data-show-toggle="true"  data-show-columns="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true">
									    <thead>
									   		 <tr>
									        	...
									        	<!--<th data-field="ord_receiptno">Order Receipt No.</th>
									       		...
									       		<th data-field="order_detail">Order</th>
									        	...
									        	<!--<th data-field="ord_no" data-align="left" data-sortable="true">Order Id</th>
									          	...
									          	<th data-field="amt_paid">Total Amount Paid</th>
      ...
      <?php
			...
			header("location:reguserlist_new.php?uid=$user_id&ohstatus");
		}
	 }
   	 ?>       				
