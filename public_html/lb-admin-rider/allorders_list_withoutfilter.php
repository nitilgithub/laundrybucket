                ...
                <div class="">
                    ...
                    <div class="">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i>All Order History</h2>
...
<!-- End Button for multiple delete-->         
                               ...
                               <table data-toggle="table" id="drycleantable"  data-url="webservice_allorderlist.php" data-pagination="true" data-show-refresh="true" data-show-toggle="true"  data-show-columns="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-strict-search="false" data-multiple-search="true">
