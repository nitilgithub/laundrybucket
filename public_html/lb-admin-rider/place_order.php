...
// if everything is ok, try to upload file
	...
	$res3=mysql_query("insert into tbl_orders(OrderUserId,Order_PickDate,Order_PickTime,PickupAddress,OrderCity,Remarks,Order_Via,CreatedBy,CreatedByName,OrderStatusId,RiderId,addon,DeliverByRider_Id,Order_DeliverDate,OrderReceiptId,OrderReceiptPic,OrderProcessType) values('$uid','$pickdate','$picktime','$pickup_address','$getcity','$remarks','$order_via','$createdby','$createdbyName','$order_status_id','$pickby',now(),'$deliverby','$deliverydate','$receiptno','$item_pic','$oprocess')");
