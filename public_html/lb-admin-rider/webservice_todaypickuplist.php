...
$result=mysqli_query($conn,$query);
	...
	$result=mysql_query("select * from tbl_orders where(OrderStatusId!=5) and STR_TO_DATE(Order_PickDate, '%m/%d/%Y') = CURDATE() or Order_PickDate=CURDATE() order by OrderId DESC") or die(mysql_error());
...
$orderdetail="Id: ".$row["OrderId"]."<br>Pickup: ".date("Y-m-d", strtotime($pickupdate))."<br>Amount: ".$row_array['order_total_amt_weight']."<br>".$data2['order_status_text']."<br>Payment: ".$row_array['payment_status'];
