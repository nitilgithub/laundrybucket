 ...
 <div class="">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i> New User</h2>
...
<!--                              <div id="columnchart_material" style="width: 900px; height: 500px;"></div>-->
                ...
                <div class="box-header">
                  <h3 class="box-title">New User added in <?php echo $val; ?></h3>
                </div>
 ...
 $(function () {
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://www.laundrybucket.co.in/lb-admin/webservice_newuser_month.php?val=<?php echo $val; ?>',
           'dataType': "json",
