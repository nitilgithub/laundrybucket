...
$(function()
{
    ...
    function drawChart() {
    	//alert(latestmonth);
      var jsonData = $.ajax({
          url: "https://laundrybucket.co.in/lb-admin/webservice_monthly_collectionchart.php?ref=Dryclean&month="+latestmonth,
          dataType: "json",
          async: false
          }).responseText;
    ...
    function drawChartlaundry() {
    	//alert(latestmonth);
      var jsonData = $.ajax({
          url: "https://laundrybucket.co.in/lb-admin/webservice_monthly_collectionchart.php?ref=Laundry&month="+latestmonth,
          dataType: "json",
          async: false
          }).responseText;
 ...
 // Uncaught Error: google.charts.load() cannot be called more than once with version 44 or earlier.
   ...
   //function for drawing chart on change of month type for dryclean type order
      function drawChartdryclean2(mon) {
      	//alert("caaled 2 - https://laundrybucket.co.in/admin/webservice_monthly_orderchart.php?month="+mon);
      var jsonData = $.ajax({
          url: "https://laundrybucket.co.in/lb-admin/webservice_monthly_collectionchart.php?ref=Dryclean&month="+mon,
          dataType: "json",
          async: false
          }).responseText;
    ...
    //function for drawing chart on change of month type for Laundry type order
     function drawChartlaundry2(mon) {
      	//alert("caaled 2 - https://laundrybucket.co.in/admin/webservice_monthly_orderchart.php?month="+mon);
      var jsonData = $.ajax({
      	  url: "https://laundrybucket.co.in/lb-admin/webservice_monthly_collectionchart.php?ref=Laundry&month="+mon,
          dataType: "json",
          async: false
          }).responseText;
 ...
 <div class="">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i> Monthly Collection Chart </h2>
