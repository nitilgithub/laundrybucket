      				...
      				<div class="panel-body">
                         ...
                         <!--end-->
							...
							<form method="post" role="form" class="form-horizontal" name="suborderform" enctype="multipart/form-data" id="suborderform">
								<div class="item form-group">
									<label class="control-label col-md-4 col-sm-5 col-xs-5" for="ordstatus">Order Type
                                    </label>
...
<script>
	...
	function settaxableamt(totalamt){
		...
		//var payableamt=document.getElementById("subpayable").value;
						...
						<div class="row">
							...
							<div class="item form-group" >
		                      <label class="control-label col-md-2 col-sm-2 col-xs-5" for="servicecat">ServiceCategory
		                     </label>
							<div class="col-md-4 col-sm-4 col-xs-7" >
		                       ...
		                       <label class="control-label col-md-2 col-sm-2 col-xs-5" for="priceunit">Price Unit
		                     </label>
							<div class="col-md-4 col-sm-4 col-xs-7" >
		                      ...
		                      &nbsp;
		                      <div class="item form-group" >
		                       <label class="control-label col-md-2 col-sm-2 col-xs-5" for="itemname">Item Name
		                       </label>
		                       ...
		                       <label class="control-label col-md-2 col-sm-2 col-xs-5" for="itemrate">Item Rate
		                       </label>
					 ...
					 <div class="panel panel-default" id="quickordershow" hidden>
								    ...
								    <div id="collapse1" class="panel-collapse collapse">
								      <div class="panel-body">
										...
										<div class="item form-group">
											 <label class="control-label col-md-2 col-sm-2 col-xs-5">Total Amount
		                                     </label>
		                                     <div class="col-md-4 col-sm-4 col-xs-7" >
	...
	if(isset($_GET['soid']))
	{
	 ...
	 ?> 	
										...
										<div class="item form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-5">Taxable Amt
		                                     </label>
		                                     <div class="col-md-4 col-sm-4 col-xs-7" >
											 ...
											 <label class="control-label col-md-2 col-sm-2 col-xs-5">DiscountOffer
		                                    </label>
		                                    <div class="col-md-4 col-sm-4 col-xs-7">
										...
										<div class="item form-group">
		                                    ...
		                                    <div class="col-md-4 col-sm-4 col-xs-7">
		                          			...
		                          			<label class="control-label col-md-2 col-sm-2 col-xs-5">OfferDiscount
		                                     </label>
		                                     <div class="col-md-4 col-sm-4 col-xs-7" >
										...
										<div class="item form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-5">Payable Amt
		                                    </label>
		                                    <div class="col-md-4 col-sm-4 col-xs-7">
		                        			...
		                        			<label class="control-label col-md-2 col-sm-2 col-xs-5">OtherDiscount
		                                     </label>
		                                     <div class="col-md-4 col-sm-4 col-xs-7" >
										...
										<div class="item form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-5">NumberOfItems
		                                    </label>
		                                    <div class="col-md-4 col-sm-4 col-xs-7">
