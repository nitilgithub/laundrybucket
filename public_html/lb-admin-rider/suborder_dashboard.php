		...
		<div class="container">
								...
								$rows1=mysql_fetch_array($res1);
                                   	...
                                   	?>
												     <td data-th="Order Id"><?php echo $oid; ?></td>
												      ...
												      <td data-th="PickUp Date" class=" "><?php echo $row1["Order_PickDate"];?></td> 
												      
												       <td data-th="PickUp By" class=" "><?php echo $rw2["empName"];?></td> 
												        <td data-th="PickUp Address" class=" "><?php echo $row1["PickupAddress"].", ".$row1["OrderCity"];?></td> 
												        
												      <td data-th="Order Amount" class=" ">₹<?php echo $row1["OrderTotalAmount"];?> </td>
												      <td data-th="Total Discount" class=" ">₹<?php echo $row1["OfferDiscount"]+$row1['ManualDiscount']+$rows1['tamount'];?> </td>
												      <td data-th="Tax(%)" class=" ">₹<?php echo $row1["TaxPercentage"];?> </td>
												      <td data-th="Payable Amount" class=" ">₹<?php echo $row1["PayableAmount"];?> </td>
	                                               <td data-th="Amount Paid" class=" ">₹<?php echo $row1["PaidAmount"];?> </td>
	                                               <td data-th="Remaining Amount" class=" ">₹<?php echo $balamt;?> </td>
	                                                <td data-th="Order Status" class=" "><?php echo  $data2["order_status_text"];?>  </td>
	                                                <td data-th="" class=" "><?php echo  $row1["Remarks"];?>  </td>
	                                     <td data-th=""><a href="payment_detail.php?oid=<?php echo $oid; ?>"><button class="btn btn-primary btn-xs">Payment Detail</button></a>
			...
			?>
											<tr class="even pointer">
												     ...
												     <td data-th="SubOrder Id"><?php echo $row['SubOrderId'];?></td>
												     
												      <td data-th="Order Type" class=" "><?php echo $row1['ServiceName'];?><br>
												      	<?php
												      ...
												      <td data-th="Delivery Type" class=" "><?php echo $row2['DeliveryTitle'];?> </td>
	                                               
	                                                <td data-th="Delivery Date" class=" "><?php echo $row['DeliveryDate'];?></td>
	                                                <td data-th="Delivery Address" class=" "><?php echo $row['DeliveryAddress'];?> </td>
	                                                <td data-th="Delivery Status"><?php echo $row3['order_status_text'];?></td>
	                                                <td data-th="Delivered By(Rider)"><?php echo $row4['empName'];?></td>
	                                                <td data-th="Order Weight(in kg)">
	                                                	<?php
				                                        if($row1['ServiceName']=="Subscription")
														{
	                                                 ...
	                                                 <td data-th="Order Amount">₹<?php echo $row['TotalAmount'];?></td>
	                                                 <td data-th="Total Discount">₹<?php echo $row['OfferDiscount']+$row['ManualDiscount']+$row5['amount'];?></td>
	                                                 <td data-th="Tax(%)">₹<?php echo $row['TaxPercentage'];?></td>
	                                                <td data-th="Payable Amount">₹<?php echo $row['PayableAmount'];?></td>
	                                                <td data-th="Actual Delivery Date"><?php echo $row['ActualDeliveryDate'];?></td>
	                                                <td data-th=""><?php echo $row['Remarks'];?></td>
	                                        <?php
	                                        if($row1['ServiceName']=="Subscription")
											{
											?>
											 <td data-th=""><a href="create_subs_suborder.php?oid=<?php echo $oid;?>&uid=<?php echo $uid;?>&soid=<?php echo $soid;?>"><button class="btn btn-primary btn-xs">Edit</button></a>
											...
											?>
											 <td data-th=""><a href="create_suborder.php?oid=<?php echo $oid;?>&uid=<?php echo $uid;?>&soid=<?php echo $soid;?>&edit=1"><button class="btn btn-primary btn-xs">Edit</button></a>
