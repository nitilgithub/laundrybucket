...
$row_array['subs_detail']="Name: ".$row["subs_name"]."<br>Service: ".$row["Subs_ServiceType"]."<br>Garment: ".$row["Subs_GarmentType"]."<br>Cost: ".$row["subs_cost"]."<br>Validity: ".$row['subs_validity']." days"."<br>Weight: ".$row["subs_wt"]." Kg"."<br>Max Pickup: ".$row["subs_maxpickup"];
