                                ...
                                <div class="x_title">
									...
									while($row=mysql_fetch_array($res))
									{
                                   	...
                                   	<tr class="even pointer">
                                   		<td data-th="User Id" title="Click on this id to view complete detail of customer"><a href="reguserlist_new.php?uid=<?php echo $uid;?>" style="color:black;display:block;"><?php echo $uid;?></a></td>
                                   		
												     <td data-th="Order Id"><?php echo $row["OrderId"];?></td>
	                                               ...
	                                               <td data-th="Amount Received By" class=" "><?php echo $row["AmountReceivedBy"];?> </td>
	                                                <td data-th="Delivery Boy" class=" "><?php if($riderid==-1){echo "-Not Applicable-";} else{ echo  $row2["RiderName"];}?>  </td>
