...
if(isset($_POST['sub']))
{
	...
	$url="webservice_allorderlist_old.php";
	$title="All";
}
...
window.actionEvents = {
    'click .btndetail': function (e, value, row, index) {
  		...
  		// window.location.href="allorders_detail.php?id="+row.order_id;
  		 window.open('allorders_detail.php?id='+row.order_id,'_blank');
    },
    
     'click .btnsuborderdetail': function (e, value, row, index) {
        //window.location.href="subscriptionorder_detail.php?id="+row.order_id;
        window.open('subscriptionorder_detail.php?id='+row.order_id,'_blank');
    ...
    <tr>
      ...
      <!--  <th data-field="srno" data-align="left" data-sortable="true">ID</th>-->
        ...
        <th data-field="order_shipaddress" data-align="left">Address</th>
         <th data-field="order_city" data-align="left" >Order City</th>
         ...
         <th data-field="order_statustext" data-align="left">Order_status</th>                  <th data-field="remarks" data-align="left">Remarks</th>                   <th data-field="delivery_type" data-align="left">Delivery Type</th>
