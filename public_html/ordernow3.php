              			...
              			<div class="col-md-12" style="border:1px solid red">
				         	...
				         	<!-- We can not do nested form, so we do this using ajax without form tag-->
				               <div class="row">
				               	...
				               	<div class="form-group">
                            	<input type="text" class="form-control text-capitalize hidden" value="<?php echo $userid; ?>" id="getuid"  name="getuid" required=""  data-form-field="LastName">
	...
	?>
               <form method="post" data-form-title="PROVIDE YOUR PICK UP DETAILS" name="ordern" onsubmit="return validateorderform(document.ordern.name,document.ordern.phone,document.ordern.laundry,document.ordern.dryclean)">
                            ...
                            <div class="form-group phonegroup">
                                <input type="tel" class="form-control phone" name="phone" required="" onblur="return phonenumber(document.ordern.phone)" data-inputmask="'mask' : '9999999999'" placeholder="Phone" data-form-field="Phone">
                                            <span id="error" style="color: Red; display: none">Please Enter Valid 10 Digits Phone Number </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-capitalize" id="ufname"  name="fname" onblur="return usname(document.ordern.fname)" required="" placeholder="Name*" data-form-field="Name">
                            <span id="nameerr" style="color: Red; display: none">Characters only </span>
                            </div>
...
if(mysql_num_rows($result)>0)
{
	...
	$result2=mysql_query("insert into tblusers(UserFirstName,UserLastName,UserEmail,UserPhone,UserPassword,UserAddress,UserRegistrationDate,UserEmailVerified,UserType,CreatedBy) values('$fname','$lname','$email','$phone','$upass','$pickup_address','$regdate','$uevstatus','$usertype','$ucreatedby')");
	if($result2)
	{
		$uid=mysql_insert_id();
