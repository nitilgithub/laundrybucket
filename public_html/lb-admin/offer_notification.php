...
$query = "SELECT DeviceId FROM tblusers where DeviceId!=''";
...
$query1 = "SELECT UserPhone FROM tblusers where UserPhone!=''";
...
$update=mysql_query("update tbl_offer set notifyStatus=1 where OfferId='$nid'");
