...
function add_new_employee_role($name)

{

	

	$query="insert into tbl_employee_role (roleName,addon) values('$name',now())";
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    ...
                                    <h2><i class="fa fa-bars"></i> Add New Employee Role</h2>
...
&nbsp;
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <input type="submit" name="btnsave" class="btn btn-success" value="Add Employee Role"/>&nbsp;
