...
if(isset($_POST['sub']))
{
	...
	$url="webservice_searchdatetodateorders.php?fdate=".$fdate."&sdate=".$sdate."&type=".$type."&ostatus=".$ostatus."&franchiseid=".$franchiseid;
}
else {
 ...
 <div class="">
                            ...
                            <div class="x_panel fixed_height_320" style="background-color:#565252;height: auto">
								...
								<form method="post" class="form-inline"> <!--action="phpexcel/datetodate.php"-->
             						...
             						<option value="all">All</option>
  									...
  									&nbsp; &nbsp;
  									<div class="form-group">
               						 	<label for="order_status"><span style="color:white"> Order Status:</span> 
             						<select  name="ostatus"  class="form-control" >
             						
             						<option value="all">All</option>
             						<?php
             						$q1=mysql_query("select * from tbl_orderstatus_id where order_status_id!=5 order by id");
             						while($rw=mysql_fetch_array($q1)){
             							?>
             							<option value="<?php echo $rw['order_status_id'];?>"><?php echo $rw['order_status_text'];?></option>
             							<?php
             						}
             						?>
             						</select>
               						...
               						<div class="form-group">
               						 	<label for="order_status"><span style="color:white"> Frenchise:</span> 
             						<select class="form-control" required name="franchiseid" id="franchise_sel">
				                     	<option value="1">Laundry Bucket</option>
										<?php
										$query1=mysql_query("select e.empId,e.empName,r.empRoleId from tbl_employee as e join tbl_per_employee_roles as r on r.empId=e.empId where r.empRoleId='9' and e.empId not in (20,22) order by e.empId");
    ...
    <div class="row">   
						 <div class="fixed-table-toolbar">
                         	...
                         	<input type="hidden" name="franchiseid" value="<?php echo $franchiseid;  ?>" />
    ...
    <tr>
        <th data-field="order_id" data-align="left" data-sortable="true">ID</th>
         ...
         <!-- <th data-field="User_Subsid" data-align="center">User_Subsid</th>-->
          ...
          <th data-field="Order_Via" data-align="center">Order Via</th>
