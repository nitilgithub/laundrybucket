...
$result=mysqli_query($conn,$query);
	 ...
	 */
										...
										$result=mysql_query("select * from tbl_orders where OrderType='trial_laundry' order by OrderId DESC") or die(mysql_error());
							 ...
							 $result2=mysql_query("select * from tbl_orderstatus_id where order_status_id='$order_statusid'") or die(mysql_error());
										...
										array_push($laundryorder_trial,$row_array);
		                             	
										
									
									   }
									 echo json_encode($laundryorder_trial);
