	 ...
	 */
		...
		
		{
		                               ...
		                               while($row=mysql_fetch_array($result))
									   {
										...
										$row_array['uid']="<a href='reguserlist_new.php?uid=".$userid."' title='Click to view user detail' target='_blank'>".$userid."</a>";
									  ...
									  $row_array['remainingweight']="Unlimited";										
											...
											$row_array['activedate']=date("m/d/Y",strtotime($row['start_date']));
