...
function add_new_serviceitem($item_name,$srate,$prate,$priceunit,$service,$servicecat,$item_pic,$item_pictemp)
...
// if everything is ok, try to upload file
	...
	$query="insert into tbl_services_itemsprice (ItemName,StandardRate,PremiumRate,PriceUnit,ServiceCatId,ServiceId,addon,item_img) values('$item_name','$srate','$prate','$priceunit','$servicecat','$service',now(),'$item_pic')";
  ...
  echo '<div class="alert alert-success">Service Item Added Successfully</div>';
...
?>
 ...
 <div class="">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    ...
                                    <h2><i class="fa fa-bars"></i> Add New Service Item </h2>
                                ...
                                <div class="x_content">
                                    ...
                                    <form method="post" role="form" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <input type="text" name="itname" class="form-control col-md-7 col-xs-12" required=""/>
            				...
            				<select name="priceunit" class="styledselect_form_1 form-control" required>
			...
			?>
									...
									<option  value="<?php echo $row['UnitId']; ?>"  style="padding-bottom:7px">Per <?php echo $row['UnitName']; ?></option>
...
&nbsp;
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-5">
                                	           ...
                                	           <input type="text" name="srate" class="form-control digitonly col-md-7 col-xs-12" required=""/>                    	
                                            ...
                                            <div class="col-md-2 col-sm-2 col-xs-5">
                                	           ...
                                	           <input type="text" name="prate"  class="form-control digitonly col-md-7 col-xs-12" required=""/>                    	
			...
			<div class="item form-group">
            				...
            				<select name="service" class="styledselect_form_1 form-control" required>
        ...
        <div class="item form-group">
            				...
            				<select name="servicecat" class="styledselect_form_1 form-control" required>
...
<?php
			...
			?>
									...
									<option  value="<?php echo $row1['ServiceCatId']; ?>"  style="padding-bottom:7px"><?php echo $row1['ServiceCatName']; ?></option>
...
<div class="item form-group">
                ...
                <input type="file" name="itpic" class="form-control col-md-7 col-xs-12" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <input type="submit" name="btnsave" class="btn btn-success" value="Add Service Item"/>&nbsp;
		...
		add_new_serviceitem($item_name,$srate,$prate,$priceunit,$service,$servicecat,$item_pic,$item_pictemp);
