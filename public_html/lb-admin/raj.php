...
$result=mysqli_query($conn,$query);
   ...
   while($row=mysql_fetch_array($result))
   {
	...
	$riderid=$row['RiderId'];
   	...
   	$result1=mysql_query("SELECT UserId,ifnull(UserEmail,'LB') UserEmail,ifnull(UserFirstName,'LB') UserFirstName,ifnull(UserLastName,'LB') UserLastName,ifnull(UserPhone,'0') UserPhone FROM tblusers where UserId='$userid'") or die(mysql_error());
