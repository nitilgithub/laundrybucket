...
if(isset($_POST['sub']))
{
	...
	$url="webservice_pendingpickuplist.php";
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Pending Pickup Order History</a>
                                            </li>
      ...
      <!--  <th data-field="srno" data-align="left" data-sortable="true">ID</th>-->
        ...
        <th data-field="order_shipaddress" data-align="left">Address</th>
         ...
         <th data-field="order_via" data-align="left">Order Via</th>
           <th data-field="order_pickby" data-align="left">Order PickedBy(Rider)</th>
            <th data-field="offercode" data-align="left">Offer Codes Applied</th>
