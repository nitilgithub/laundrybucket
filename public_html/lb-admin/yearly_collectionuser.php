 ...
 <div class="">
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i> Yearly Collection (New/Existing Customers)</h2>
...
<!--                              <div id="columnchart_material" style="width: 900px; height: 500px;"></div>--
 ...
 $(function () {
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://laundrybucket.co.in/lb-admin/webservice_yearly_collectionuser.php?ref=<?php echo $ref; ?>&val=<?php echo $val; ?>',
           'dataType': "json",
 ...
 //BAR CHART
     ...
     /* $(function () {
       ...
       $.ajax({
           'async': false,
           'global': false,
           'url': 'https://beta.laundrybucket.co.in/lb-admin/webservice_yearly_collectionchart.php?ref=Laundry&val=',
           'dataType': "json",
           'success': function (data) {
               json = data;
           }
