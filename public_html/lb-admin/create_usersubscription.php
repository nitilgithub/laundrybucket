...
function showsubscriptionDetail(substypeid) {
  ...
  url="api_getsubsdetail.php?subsid="+substypeid+"&uid="+uid;
 // alert(url);
...
<?php
		...
		if(isset($_POST["btnsave"]))
		{
			...
			$subsid=mysql_real_escape_string(trim($_POST["substype"]));
			
			$soldby=mysql_real_escape_string(trim($_POST["soldby"]));
			$subsdate=mysql_real_escape_string($_POST['subsdate']);
			
			$startdate = date('F d, Y',strtotime($subsdate));
			...
			$subs_name=mysql_real_escape_string(trim($_POST["subs_name"]));
			$subs_cost=mysql_real_escape_string(trim($_POST["subs_cost"]));
			$subs_wt=mysql_real_escape_string(trim($_POST["subs_wt"]));
			$subs_maxpickup=mysql_real_escape_string(trim($_POST["subs_maxpickup"]));
	...
	$result2=mysql_query("insert into tbl_usersubscriptions(UserId,subs_id,subs_date,start_date,next_renewal,last_renewal,max_pickup,used_weight,subs_status,soldby,addon) values('$uid','$subsid','$startdate','$startdate','$new_renewal','$startdate','$maxpickup','$used_weight','$subs_status','$soldby',NOW())");
...
curl_close($ch);
			...
			header( "refresh:1;url=https://www.laundrybucket.co.in/lb-admin/reguserlist_new.php" );
		}                       	
	}                             	
?>                                	
...
?>
 <form method="post" role="form" class="form-horizontal" name="ordern" enctype="multipart/form-data">
                                ...
                                <input type="hidden" value="<?php echo $userid;?>" id="uuid" />
                                            </div>
                                        </div>
							...
							<?php										
								...
								?>
                                  ...
                                  <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="soldby">Subscription Sold By
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                      
                                    <input type="text" class="form-control col-md-7 col-xs-12 text-capitalize"  name="soldby" id="soldby"  placeholder="Enter name of person who sold subscription" data-form-field="Name">
                                  ...
                                  &nbsp;
                                   <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="soldby">Subscription Date
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                      
                                    <input type="text" class="form-control col-md-7 col-xs-12 datepicker"  name="subsdate" id="subsdate"  placeholder="Select Subscription Date" data-form-field="Subs date">
                          ...
                          <div class="subsdetail form-group" id="subsdetail">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-md-offset-3">
                                                ...
                                                <input type="submit" name="btnsave" class="btn btn-success" id="btnsubmit" value="Finish"/>&nbsp;
                                            </div>
                                        </div>
                                    </form>
