                            ...
                            <ul class="nav side-menu">
                                ...
                                <li class="ord">
                                    ...
                                    <ul class="nav child_menu" style="display: none">
                                        ...
                                        <li><a href="charts.php"> Yearly Orders</a>
                                         ...
                                         <li><a href="orderfromnggn.php"> Orders from particular City per month</a>
                                        </li>
                                        
                                         <li><a href="yearly_collectionuser.php"> Yearly Collection(New vs Existing User)</a>
                                        </li>
                                ...
                                <li><a><i class="fa fa-history"></i> Orders <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                    	...
                                    	<li><a href="offer_orders.php">Combo Offer Orders</a> </li>
                                    	
                                    	 <?php if($_SESSION['loginrole']!=9){?>
                                    	<li><a href="allorder_list_old.php">All  Orders (Old)</a> </li>
                                    	<?php } ?>
                                    	<li><a href="filtered_order.php">Filtered Orders</a> </li>
                                    	<!--
      ...
      <a href="subscription_orderlist.php" class="list-group-item" id="lst-group-item">Subscription Orders</a>
         ...
         -->
                               ...
                               -->
                                 ...
                                 <?php if($_SESSION['loginrole']==2 || $_SESSION['loginrole']==3){?>
                                 <li class="ord"><a href="querycontact.php"><i class="fa fa-question-circle"></i> Contact US Query</a>
                                  ...
                                  <?php if($_SESSION['loginrole']==2 || $_SESSION['loginrole']==3){?>	
                                 <li><a href="datetodate_user.php"><i class="fa fa-file-excel-o"></i> Get Users Excel </a>
                                 	<?php } ?>
                              ...
                              <li><a href="ratelist.php"><i class="fa fa-plus" aria-hidden="true"></i> Rate List </a>
                               ...
                               <li class="ord"><a><i class="fa fa-table"></i>SERVICE Category <span class="fa fa-chevron-down"></span></a>
                                ...
                                <?php if($_SESSION['loginrole']==2 || $_SESSION['loginrole']==3 || $_SESSION['loginrole']==9){?>
                                 <li class="ord"><a><i class="fa fa-money"></i>Payment Details<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                ...
                                <?php if($_SESSION['loginrole']==2 || $_SESSION['loginrole']==3){?>
                                <li class="ord"><a><i class="fa fa-comments"></i>Feedback Status<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                ...
                                <?php }?>
                                  ...
                                  <li class="ord"><a><i class="fa fa-tags"></i>Offers<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="offer_list.php">Offers List</a>
                                        </li>
                                        <li><a href="combo_offer_list.php">Combo Offers List</a>
                                        </li>
                                         <?php if($_SESSION['loginrole']==2){?>
                                        <li><a href="add_offer.php">Add New Offer</a>
                                        </li>
                                        <li><a href="add_surprise_offer.php">Surprise Offer(App Users)</a>
                                        </li>
                                        <li><a href="add_combo_offer.php">Add New Combo Offer</a>
                                        </li>
                                        <?php } ?>
                                    </ul>
                                </li>
                                
                                <li class="ord"><a><i class="fa fa-bell"></i>Notifications<span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="sendpush.php">Send Push Notification</a>
                                        </li>
                                        <li><a href="notification_list.php">Notification List</a>
                                        </li>
            ...
            <div class="top_nav">
                ...
                <div class="nav_menu">
                    <nav class="" role="navigation">
                        ...
                        <?php  if($_SESSION['loginrole']==9){
                        	$q=mysql_query("select * from tbl_employee where empId='".$_SESSION['loginid']."'");
							$r=mysql_fetch_array($q);
							echo "<span style='color:#fff; font-size:22px;'>".$r['empName']."</span>";
                        }?>
                        </div>
                        <div class="col-md-4">
						<button class="btn btn-default" style="margin-top: 5px;" id="btnNewOrder">New Orders &nbsp;<span class="badge"></span></button>
						<button class="btn btn-default" style="margin-top: 5px;" id="btnNewEnquiry">New Enquiries &nbsp;<span class="badge"></span></button>
						</div>
						<div class="col-md-4">
