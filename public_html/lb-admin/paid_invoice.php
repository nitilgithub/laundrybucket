...
if(isset($_POST['sub']))
{
	...
	$url="webservice_paid_orderlist.php";
	$title="All";
}
                ...
                <div class="">
                    ...
                    <div class="">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i><?php echo $title; ?> Paid Order History</h2>
                                    <h2> &nbsp;&nbsp;&nbsp;&nbsp;Total Paid Amount: ₹ 
                                   <?php
                                   if($_SESSION['loginrole']==9)
									{
										$result=mysql_query("select ifnull(sum(PaidAmount),0) from tbl_orders where(OrderStatusId!=5) and franchiseId='".$_SESSION['loginid']."'") or die(mysql_error());
									}			
									else {
                                   $result=mysql_query("select ifnull(sum(PaidAmount),0) from tbl_orders where(OrderStatusId!=5)") or die(mysql_error());
									}
...
<!-- End Button for multiple delete-->         
    ...
    <tr>
      ...
      <!--  <th data-field="srno" data-align="left" data-sortable="true">ID</th>-->
        ...
        <th data-field="paid_amt" data-align="left">Paid Amount</th> 
