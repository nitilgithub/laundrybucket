                                ...
                                <div class="x_title">
                                    <h2><i class="fa fa-bars"></i> 
										...
										if(mysql_affected_rows())
										{
										 ...
										 echo $urow['UserFirstName']." ".$urow['UserLastName']."'s Payment History ";
										}
										 ?>
                                    ...
                                    <?php
                                    $res=mysql_query("select * from tbl_payment_history where UserId='$uid'") or die(mysql_error());
									while($row=mysql_fetch_array($res))
									{
                                   	...
                                   	<tr class="even pointer">
                                   		<td title="Click on this id to view complete detail of customer"><a href="reguserlist_new.php?uid=<?php echo $uid;?>" style="color:black;display:block;"><?php echo $uid;?></a></td>
                                   		
												     <td><?php echo $row["OrderId"];?></td>
												     
												      <td class=" ">₹ <?php echo $row["AmountPaid"];?></td> <!-- if user name not exist in table tblusers then fetch username from tbl_orders-->
												      <td class=" "><?php 
												      if($row1["PaymentMode"]==""){
												      	echo $paymentmode;
													  }
												      ...
												      ?> </td>
	                                               <td class=" "><?php echo $row["AmountReceivedBy"];?> </td>
	                                                <td class=" "><?php if($riderid==-1){echo "-Not Applicable-";} else{ echo  $row2["RiderName"];}?>  </td>
	                                                <td class=" "><?php echo  $row["AmountReceivedOn"];?>  </td>
				...
				<div class="row">
					<div class="col-md-9 col-sm-9 col-xs-12">
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-4 col-sm-6 col-xs-12" style="height: 310px;">
