		...
		if(isset($_POST["btnsave"]))
		{
			...
			$upwd=mysql_real_escape_string(md5($_POST['upwd']));
				$udob=mysql_real_escape_string($_POST['udob']);
					...
					$uref=mysql_real_escape_string($_POST['reference']);
					
					$reftxt=mysql_real_escape_string(trim($_POST["reftxt"]));
					$franchiseid=mysql_real_escape_string(trim($_POST['franchiseid']));
...
'$uvcode','$uip','$uph','$ufax','$uc','$uadd','$ua',$uuby,'$uremark','$ucreatedby','$uref','$reftxt','$franchiseid')";
// echo $query;
					...
					if(mysql_affected_rows())
	{
		...
		//echo $userid;
		//$res2=mysql_query("insert into tblusers_address(UserId,Address,addon) values('$userid','$uadd',NOW())");
...
<?php
	...
	?>
              ...
              <div class="item form-group">
            				...
            				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="reference">  How user know about us? <span>*</span> </label>
            				<div class="col-md-6 col-sm-6 col-xs-12">
           ...
           <div class="item form-group" id="reftxtdiv" hidden>
                    	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="reftxt"> Other Reference
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12" >
                    ...
                    &nbsp;
                    <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="franchiseid">Franchise
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
