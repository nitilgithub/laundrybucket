                                ...
                                <div class="x_title">
									...
									while($row=mysql_fetch_array($res))
									{
                                   	...
                                   	<tr class="even pointer">
                                   		<td title="Click on this id to view complete detail of customer"><a href="reguserlist_new.php?uid=<?php echo $row["UserId"];?>" style="color:black;display:block;"><?php echo $row["UserId"];?></a></td>
	                                               ...
	                                               <td class=" "><?php echo $row["AmountReceivedBy"];?> </td>
	                                                <td class=" "><?php if($riderid==-1){echo "-Not Applicable-";} else{ echo  $rw2["empName"];}?>  </td>
