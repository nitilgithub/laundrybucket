...
<title><?php echo $service;?> Service in <?php echo $location;?>, <?php echo $city;?></title>
...
<link rel="canonical" href="https://laundrybucket.co.in/<?php echo $service;?> Service in <?php echo $location;?>, <?php echo $city;?>"/>
...
<div id="request_free">
	<form method="post" id="frmcontactenquiry3">
            <a class="anchor">
   ...
   <div class="form-group">
	...
	<input type="button" value="Send Your Message" name="submit" id="btnsendcontact3" class="btn btn-info pull-right" title="Click here to submit your message!" />
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<h2 class="alert alert-info" align="center"><?php echo $service;?>  in <?php echo $location;?>, <?php echo $city;?></h2>
      ...
      <div class="panel-body">
      	...
      	while($row1=mysql_fetch_array($res1))
		{
      	...
      	<tr>
      		...
      		<td><?php echo $row1['StandardRate']." /".$r1['UnitName'];?></td>
      		<td><?php echo $row1['PremiumRate']." /".$r1['UnitName'];?></td>
      	</tr>
      	<?php
		}
      	?>
...
<div class="col-md-6 hidden-sm hidden-xs" style="padding-left: 10px;padding-right: 10px;">
		...
		<div class="vidimg">
			<div class="play-vid">
				<a class="popup-youtube" href="https://www.youtube.com/watch?v=VTHQEOpY2zY"><span class="fa fa-play fa-3x playvid"></span></a>
			</div>
			<img src="img/screen.png" alt="" class="img-responsive">
		</div>
</div>
